...
if ( DhcpOptions.len[nisServers] > 3 )
  {
    fprintf(f,"\
\nNISSERVERS=%u.%u.%u.%u",
...
if ( DhcpOptions.len[lprServer] > 3 )
  {
    fprintf(f,"\
\nLPRSERVERS=%u.%u.%u.%u",
((unsigned char *)DhcpOptions.val[lprServer])[0],
((unsigned char *)DhcpOptions.val[lprServer])[1],
((unsigned char *)DhcpOptions.val[lprServer])[2],
((unsigned char *)DhcpOptions.val[lprServer])[3]);
	  for (i=4;i<DhcpOptions.len[lprServer];i+=4)
  	    fprintf(f,",%u.%u.%u.%u",
	    ((unsigned char *)DhcpOptions.val[lprServer])[i],
	    ((unsigned char *)DhcpOptions.val[lprServer])[1+i],
	    ((unsigned char *)DhcpOptions.val[lprServer])[2+i],
	    ((unsigned char *)DhcpOptions.val[lprServer])[3+i]);
	}

if ( DhcpOptions.len[logServer] > 3 )
  {
    fprintf(f,"\
\nLOGSERVERS=%u.%u.%u.%u",
((unsigned char *)DhcpOptions.val[logServer])[0],
((unsigned char *)DhcpOptions.val[logServer])[1],
((unsigned char *)DhcpOptions.val[logServer])[2],
((unsigned char *)DhcpOptions.val[logServer])[3]);
	  for (i=4;i<DhcpOptions.len[logServer];i+=4)
  	    fprintf(f,",%u.%u.%u.%u",
	    ((unsigned char *)DhcpOptions.val[logServer])[i],
	    ((unsigned char *)DhcpOptions.val[logServer])[1+i],
	    ((unsigned char *)DhcpOptions.val[logServer])[2+i],
	    ((unsigned char *)DhcpOptions.val[logServer])[3+i]);
	}

if ( DhcpOptions.len[sohoServer] > 3 )
  {
    fprintf(f,"\
\nSOHOSERVER=%u.%u.%u.%u",
((unsigned char *)DhcpOptions.val[sohoServer])[0],
((unsigned char *)DhcpOptions.val[sohoServer])[1],
((unsigned char *)DhcpOptions.val[sohoServer])[2],
((unsigned char *)DhcpOptions.val[sohoServer])[3]);
	  for (i=4;i<DhcpOptions.len[sohoServer];i+=4)
  	    fprintf(f,",%u.%u.%u.%u",
	    ((unsigned char *)DhcpOptions.val[sohoServer])[i],
	    ((unsigned char *)DhcpOptions.val[sohoServer])[1+i],
	    ((unsigned char *)DhcpOptions.val[sohoServer])[2+i],
	    ((unsigned char *)DhcpOptions.val[sohoServer])[3+i]);
	}
