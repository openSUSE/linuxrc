...
typedef enum {
  ...
  key_yast2serial, key_textmode, key_usb, key_yast2color, key_bootdisk,
  ...
  key_ipaddr, key_hostname, key_nisdomain, key_nisservers, key_dns,
  key_nptservers, key_dhcpsid, key_dhcpgiaddr, key_dhcpsiaddr,
